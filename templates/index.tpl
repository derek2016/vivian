...
<section id="main-slider">
	<div class="owl-carousel">
		<div class="item" style="background-image: url({$web_images}/slider/bg1.jpg);">
			<div class="slider-inner">
				<div class="container">
					<div class="row">
						<div class="carousel-caption">
							<div class="carousel-content">
								<h2>Best Interiors Theme</h2>
		...
		<!--/.item-->
		<div class="item" style="background-image: url({$web_iamges}/slider/bg2.jpg);">
			<div class="slider-inner">
				<div class="container">
					<div class="row">
						<div class="carousel-caption">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6 wow fadeInLeft">
				<img class="img-responsive" src="{$web_images}/about.png" alt="">
			</div>
	...
	<div class="container">
		...
		<div class="text-center" style="display: none">
			<ul class="portfolio-filter">
				<li>
					<a class="active" href="#" data-filter="*">All Works</a>
				</li>
				<li>
					<a href="#" data-filter=".designing">Designing</a>
				</li>
				<li>
					<a href="#" data-filter=".mobile">Mobile App</a>
				</li>
				<li>
		...
		<div class="portfolio-items">
			<div class="portfolio-item designing">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="{$web_images}/portfolio/1.jpg" alt="">
					<div class="portfolio-info">
						<h3>Some Name</h3>
						<a class="preview" href="{$web_images}/portfolio/1.jpg" rel="prettyPhoto">
							<i class="fa fa-eye"></i>
						</a>
					</div>
				</div>
			...
			<div class="portfolio-item mobile development">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="{$web_images}/portfolio/2.jpg" alt="">
					<div class="portfolio-info">
						<h3>Some Name</h3>
						<a class="preview" href="{$web_images}/portfolio/2.jpg" rel="prettyPhoto">
							<i class="fa fa-eye"></i>
						</a>
					</div>
				</div>
			...
			<div class="portfolio-item designing">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="{$web_images}/portfolio/3.jpg" alt="">
					<div class="portfolio-info">
						<h3>Some Name</h3>
						<a class="preview" href="{$web_images}/portfolio/3.jpg" rel="prettyPhoto">
							<i class="fa fa-eye"></i>
						</a>
					</div>
				</div>
			...
			<div class="portfolio-item mobile">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="{$web_images}/portfolio/4.jpg" alt="">
					<div class="portfolio-info">
						<h3>Some Name</h3>
						<a class="preview" href="{$web_images}/portfolio/4.jpg" rel="prettyPhoto">
							<i class="fa fa-eye"></i>
						</a>
					</div>
				</div>
			...
			<div class="portfolio-item designing development">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="{$web_images}/portfolio/5.jpg" alt="">
					<div class="portfolio-info">
						<h3>Some Name</h3>
						<a class="preview" href="{$web_images}/portfolio/5.jpg" rel="prettyPhoto">
							<i class="fa fa-eye"></i>
						</a>
					</div>
				</div>
			...
			<div class="portfolio-item mobile">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="{$web_images}/portfolio/6.jpg" alt="">
					<div class="portfolio-info">
						<h3>Some Name</h3>
						<a class="preview" href="{$web_images}/portfolio/6.jpg" rel="prettyPhoto">
							<i class="fa fa-eye"></i>
						</a>
					</div>
				</div>
			...
			<div class="portfolio-item designing development">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="{$web_images}/portfolio/7.jpg" alt="">
					<div class="portfolio-info">
						<h3>Some Name</h3>
						<a class="preview" href="{$web_images}/portfolio/7.jpg" rel="prettyPhoto">
							<i class="fa fa-eye"></i>
						</a>
					</div>
				</div>
			...
			<div class="portfolio-item mobile">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="{$web_images}/portfolio/8.jpg" alt="">
					<div class="portfolio-info">
						<h3>Some Name</h3>
						<a class="preview" href="{$web_images}/portfolio/8.jpg" rel="prettyPhoto">
							<i class="fa fa-eye"></i>
						</a>
					</div>
				</div>
...
<section id="our-team">
	<div class="container">
		<div class="section-header">
			<h2 class="section-title text-center wow fadeInDown">Our Best Team</h2>
			<p class="text-center wow fadeInDown">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget risus vitae massa
				<br>
				semper aliquam quis mattis quam.
		...
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
					<div class="team-img">
						<img class="img-responsive" src="{$web_images}/team/01.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>John Deo</h3>
						<span>CEO</span>
			...
			<div class="col-md-3 col-sm-6">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
					<div class="team-img">
						<img class="img-responsive" src="{$web_images}/team/02.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Mike Timobbs</h3>
						<span>Manager</span>
			...
			<div class="col-md-3 col-sm-6">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
					<div class="team-img">
						<img class="img-responsive" src="{$web_images}/team/03.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Remo Silvaus</h3>
						<span>Designer</span>
			...
			<div class="col-md-3 col-sm-6">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
					<div class="team-img">
						<img class="img-responsive" src="{$web_images}/team/04.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Niscal Deon</h3>
						<span>Engineer</span>
			...
			<div class="col-sm-6 col-md-3">
				<div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="0ms">
					<ul class="pricing">
						...
						<li>
							<p>Nique porriqua tquises dolorem desumquia doloresamet consectet adipisci. Masagni dolores eoquie voluptate sequi saliquam quaerat voluptate.</p>
						</li>
				...
				<div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<p>
								<img class="img-thumbnail" src="{$web_images}/pic1.jpg" alt="">
							</p>
							<h4>John Deo</h4>
						...
						<div class="item">
							<p>
								<img class="img-thumbnail" src="{$web_images}/pic2.jpg" alt="">
							</p>
							<h4>Gramth Larry</h4>
